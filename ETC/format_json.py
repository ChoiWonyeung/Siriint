                ...
                [
                     {
                         'title':
                             {
                                 '{lang}': '' or None  # 카탈로그 제목 # {lang}len[0, 100]
                             },
                         'description':
                             {
                                 '{lang}': '' or None  # 카탈로그 설명 # {lang}len[0,10000]
                             },
                         'image': '' or None  # 카탈로그 이미지
                     }
                ],
            'thumbnail': '' or None,  # 상품 썸네일
            'name':
                {
                    '{lang}': '' or None  # 상품의 이름 # 필수
                },
            'summary':
                {
                    '{lang}': '' or None  # 상품의 요약 설명
                },
            'description':
                {
                    '{lang}': '' or None  # 상품에 대한 설명 # {lang}len[0, 50000]
                },
            'notices':
                [
                    {
                        'slug': '',  # 알림성 컨텐츠 슬러그 # 한국의 상품 고시 정보는 "legal-KR_"로 시작하는 슬러그로 예약 사용
                        'title':
                            {
                                '{lang}': '' or None  # 알림성 컨텐츠 제목 # {lang}len[0, 100]
                            },
                        'items':  # 알림성 컨텐츠 세부 목록
                            [
                                {
                                    'title':
                                        {
                                            '{lang}': '' or None  # 세부 목록의 제목 # {lang}len[0, 100]
                                        },
                                    'description':
                                        {
                                            '{lang}': '' or None  # 세부 컨텐츠의 설명 # {lang}len[0, 10000]
                                        }
                                }
                            ]
                    }
            ...
            'price':  # 상품의 가격 설정 정보 # 필수
                {
                    ...
                    'type': '' or 'fixed' or 'dynamic'  # 필수 # fixed=고정가격 # dynamic=동적가격
                },
            'discount':  # 상품 할인 정보
                {
            ...
            'shipping':  # 상품 배송 설정 # 필수 # '' or 'tangible'
                {
                    'methods':
                        ...
                        'calculation': '' or 'bundled' or 'separated' or None  # 상품의 계산 방식 # 필수
                    },
                ...
                [
                    {
                        'name':
                            {
                                '{lang}': '' or None  # 옵션 이름 # {lang}len[0,50]
                            },
                            ...
                            [
                                {
                                    'value':
                                        {
                                            '{lang}': '' or None   # 옵션의 선택지 값 # {lang]len[0,150]
                                        },
                ...
                [
                    {
                        ...
                        'name':
                            {
                                '{lang}': '' or None  # 추가 구매 옵션의 이름 # {lang}len[0,100]
                            },
                        'items':  # 추가 구매 옵션의 품목
                            [
                                {
                                    'product': '',  # 추가 구매 옵션 품목의 상품 # 필수
                                    'variant': ''   # 추가 구매 옵션 품목의 세부 품목                                    }
                                }
                            ]
                    }
                ],
